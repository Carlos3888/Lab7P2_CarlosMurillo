...
public class Plantas {
    ...
    public String toString() {
        return "Plantas{" + "nombre=" + nombre + ", ataque=" + ataque + ", vida=" + vida + ", rango=" + rango + ", explsion=" + explsion + ", proyectil=" + proyectil + ", color=" + color + ", altura=" + altura + ", peso=" + peso + ", dureza=" + dureza + '}';
    }
